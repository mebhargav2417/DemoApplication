...
<form action="/" method="post" style="width:75%">
  ...
  <div class="group">
    <input type="email" id="email" required autocomplete="off" /><span class="highlight"></span><span class="bar"></span>
    <label>Email</label>
  </div>
  <div class="group">
    <input type="password" id="pwd" required autocomplete="off" /><span class="highlight"></span><span class="bar"></span>
    <label>Password</label>
  </div>
  <button type="button" id="login" class="button buttonBlue">Login
